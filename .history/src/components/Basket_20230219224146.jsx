...
export default function Basket(props) {
  ...
  if(addedProdId == null) {
    ...
    if(addedProducts.includes(addedProdId)) {
      ...
      setBasketProducts([...BasketProducts, <BasketProduct key={addedProdId} product={products[addedProdId]} />])
    }
  }
    ...
    <div className={`Basket ${isBasketOpen == false ? 'Basket--Close' : 'Basket--Open'}`} onClick={handleOpenBasket}>
      ...
      <>
        ...
        <div className='Basket__FullPrice'>
          <div className='Basket__FullPrice__Title'>
            Price: 
          </div>
          <div className='Basket__FullPrice__Price'>
            {FullPrice}
          </div>
        </div>
      </>
