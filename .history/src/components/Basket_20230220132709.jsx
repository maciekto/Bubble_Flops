  ...
  if(addedProdId == null) {
      ...
      if(arrayOfId.includes(addedProdId)) {
          ...
          setaddedProductsIds([...addedProductsIds, {
           ...
           setBasketProductsComponents([...BasketProductsComponents, <BasketProduct key={addedProdId} product={products[addedProdId]} count={addedProductsIds.length == 0 ? 1 : 2}/>])
    ...
    console.log(addedProductsIds.length)
