  ...
  if(addedProdId == null) {
      ...
      if(arrayOfId.includes(addedProdId)) {
          ...
          setaddedProductsIds([...addedProductsIds, {
           ...
           setBasketProductsComponents([...BasketProductsComponents, <BasketProduct key={addedProdId} product={products[addedProdId]} count={addedProductsIds[addedProdId].amount}/>])
